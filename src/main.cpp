...
int main() {
    ...
    unsigned int diffuseMap = loadCubemap(faces);

    std::vector<std::string> facesSpecular = {
    ...
    unsigned int specularMap = loadCubemap(facesSpecular);
    unsigned int emissionMap = loadCubemap(faces);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glBindTexture(GL_TEXTURE_CUBE_MAP, emissionMap);
